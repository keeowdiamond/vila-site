        ...
        <SectionReveal>
          <section className="mt-32">
            ...
            <ul className="mt-6 space-y-3 text-zinc-600 max-w-3xl list-disc pl-5">
              ...
              <li>
                <span className="font-medium text-zinc-900">Military & Veteran Discount:</span>{" "}
                We proudly offer a discount for active-duty military and veterans. Please mention in-store.
              </li>
              <li>
                <span className="font-medium text-zinc-900">First-Time Customer Discount:</span>{" "}
                New customers receive 10% off their first service.
              </li>
